...
/**
 * Created by xiaobozhang on 1/25/15.
 */

public class MenuSlidingActivity extends Activity {
    ...
    private String[] menuItems = { "menu Item 1", "menu Item 2", "menu Item 3",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*menu*/
        contentListView = (ListView) findViewById(R.id.contentListMenu);
        contentListAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1,
                menuItems);
        contentListView.setAdapter(contentListAdapter);
        // 将监听滑动事件绑定在contentListView上
